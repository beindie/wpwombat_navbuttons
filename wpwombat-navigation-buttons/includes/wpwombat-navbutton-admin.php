...
if (!class_exists('WPWombat_PostNavigationAdmin'))
{
    final class WPWombat_PostNavigationAdmin
    {
        ...
        public function add_menu_button()
        {
            ...
            {
                add_options_page(__('Nav Buttons', 'wpwombat-navigation-buttons'), __('Nav Buttons', 'wpwombat-navigation-buttons'), 'manage_options', 'wpwombat_navbuttons_page_settings', [&$this, 'admin_page_init']);
            }
        }
