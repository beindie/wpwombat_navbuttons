...
if (isset($_POST['submit-navigation-form']) && wp_verify_nonce($_POST['navigate-buttons-nonce-field'], 'navigation-buttons-save'))
{
    ...
    {
        $wombat_navbutton_options[$key] = $val;
    }
...
<h1><?php _e('Navigation Buttons - Customization ', 'wpwombat-navigation-buttons'); ?></h1>
...
<nav class="nav-tab-wrapper">
      <a href="<?php menu_page_url('wpwombat_navbuttons_page_settings', true ); ?>" class="nav-tab <?php if($tab===null):?>nav-tab-active<?php endif; ?>">Customization</a>
      <a href="<?php menu_page_url('wpwombat_navbuttons_page_settings', true ); ?>&tab=about" class="nav-tab <?php if($tab==='settings'):?>nav-tab-active<?php endif; ?>">About</a>
</nav>
...
?>
<div class="wombat-admin-body" style="padding-right:10px;">
<h1><?php _e('Navigation Buttons - About ', 'wombat-navigation-buttons'); ?></h1>
